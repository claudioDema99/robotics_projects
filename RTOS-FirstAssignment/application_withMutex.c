...
In this code I have directly implemented (beyond the first 5 points) the semaphore with a priority ceiling access protocol as it is described in the 6th task.
The rest of the code is the same as "application.c".
